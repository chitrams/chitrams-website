...
I also find the following figure handy to understand how the `map` functions work: <img src="map-function-R.png" alt="The map function in R." width="300"/><br> *From Hadley Wickham's [Advanced R](https://adv-r.hadley.nz/functionals.html).*
