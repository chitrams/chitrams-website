...
The textbook I enjoyed most for this was *The Linux Command Line* by William Shotts (freely available [here](https://linuxcommand.org/tlcl.php)). It gives an accessible and friendly explanation of what's going on. See also my [list of command line tips and resources](https://chitra-ms.com/code-collection/2024-09-13-command-line-tips/).
