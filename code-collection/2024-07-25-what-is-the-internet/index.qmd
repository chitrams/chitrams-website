...
description: "Going down the rabbit hole: debugging my website led to learning about domain names, servers, the World Wide Web, and how the internet works."
author: ''
date: '2024-07-24'
...
## Casual reads
- Tubes: A Journey to the Centre of the Internet by Andrew Blum ([Goodreads](https://www.goodreads.com/book/show/13036199-tubes)). An excellent narrative non-fiction that explains the physical reality of the internet.
- Computer Networking: A Top-Down Approach by James F. Kurose and Keith W. Ross ([Goodreads](https://www.goodreads.com/book/show/83847.Computer_Networking)). An excellent textbook that explains how the internet works. I like that they provide context for the concepts taught, good examples, and just excellent readability. You can also find James Kurose explaining the internet at five levels (from child to expert) in [this video](https://www.youtube.com/watch?v=0EqKnvzo3no).
